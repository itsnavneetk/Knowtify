...
<html>
    ...
    foreach ($_SESSION["cart_item"] as $item){
        ...
        <h3>Order total :₹<?php echo $item_total?> </h3>
...
<?php
    ...
    <form action="<?php echo $paypal_link; ?>" method="post">
        ...
        src="https://woocommerce.com/wp-content/uploads/2016/04/PayPal-Express@2x.png" alt="PayPal - The safer, easier way to pay online">
        <img alt="" border="0" width="1" height="1" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" ><br>
    	<input type="button" value="Cash on delivery" onclick="window.location='../index.php';">
    </form>

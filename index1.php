...
function success(position) {
  ...
  //alert(lngs);
    ...
    var infoWindowContent = [
        ...
        '<h3>Aditya Mess</h3>' +
        '<h5>Restaurant</h5>'+
        '<p>Varied options and low prices plus food quality is amazing</p>'+'<p><h3>HOT OFFERS</h3><h3>Happy Hours</h3></p>'+'<form method="POST" action="">'+'<button onclick="myFunction(3)">NOTIFY!</button>'+'</form>'+
        '</div>'],
